...
4. Déployer avec le projet Vercel et l’intégration GitHub **existants**, après accord sur le risque de migration additive. Réutiliser les variables Neon et les secrets de session/chiffrement déjà enregistrés dans Vercel ; n’ajouter **aucune** clé CinetPay/Twilio/WhatsApp. Ne pas tester avec une base fictive en Production.
