...
| `npm run test:merchant-preview` | ✅ Better Auth accepte l’origine de la Preview Vercel et ses liens d’invitation restent sur cette Preview même si `PUBLIC_BASE_URL` indique le domaine Production. | Simulation **locale**, pas un déploiement Vercel réel. |
