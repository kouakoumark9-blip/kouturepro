const CACHE='kouturepro-shell-v9';
const ESSENTIAL=['/','/app','/favicon.svg','/icon-192.png','/icon-512.png','/manifest.webmanifest','/marchands.webmanifest','/assets/atelier-hero.jpg','/assets/gallery-style.jpg','/assets/gallery-wax.jpg','/assets/gallery-studio.jpg'];
...
self.addEventListener('fetch',event=>{
 ...
 if(req.method!=='GET'||url.origin!==self.location.origin||url.pathname.startsWith('/api/')||url.pathname.startsWith('/receipt/')||url.pathname.startsWith('/pay/')||url.pathname.startsWith('/marchands/invite/')||url.pathname.startsWith('/marchands/reset')||url.pathname.includes('/@vite')||url.pathname.includes('/__vite'))return;
