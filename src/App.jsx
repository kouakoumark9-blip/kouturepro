...
const navGroups=[
 {label:'PRINCIPAL',items:[['/app','Tableau de bord',LayoutDashboard],['/app/orders','Commandes',ShoppingBag],['/app/production','Production',Layers3],['/app/clients','Clients',UsersRound]]},
 {label:'GESTION',items:[['/app/payments','Paiements & caisse',Wallet],['/app/stock','Stock & fournisseurs',Boxes],['/app/team','Équipe & boutiques',UserRoundCheck]]},
 {label:'DÉVELOPPEMENT',items:[['/app/showcase','Ma vitrine',Store],['/app/stats','Statistiques',ChartNoAxesCombined],['/app/settings','Paramètres',Settings2]]}
];
...
function Sidebar(){const {data,path,navigate,branch,setBranch,setQuick,online,pending,logout}=useApp();const org=data.organization;return <aside className="sidebar"><div className="sidebar-top"><button className="brand" onClick={()=>navigate('/app')}><span className="brand-mark"><Scissors size={22} strokeWidth={2}/></span><span className="brand-type"><strong>Kouture<span>Pro</span></strong><small>ENTERPRISE</small></span></button>
 ...
 <div className="sidebar-bottom"><div className="sidebar-promo"><div className="promo-spark"><Sparkles size={17}/></div><strong>Votre vitrine est en ligne</strong><p>Faites découvrir votre savoir-faire à de nouveaux clients.</p><a href={orgPublicPath(data)} target="_blank" rel="noreferrer">Voir ma vitrine <ArrowUpRight size={14}/></a></div>
